  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h2 className="text-2xl sm:text-3xl font-bold text-slate-900">Team & Judge Allocation</h2>
          <p className="text-sm sm:text-base text-slate-600 mt-1">Assign judges to teams for each round</p>
        </div>
      </div>
