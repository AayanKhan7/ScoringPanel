  ...
  return (
    <div className="space-y-6 px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-2">
        <div>
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-slate-900">Admin Dashboard</h1>
          <p className="text-xs sm:text-sm text-slate-600 mt-1">Overview of all events and activities</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white border border-slate-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow flex flex-col justify-between h-32">
          ...
          <div>
            <p className="text-2xl font-bold text-slate-900">{stats.totalJudges}</p>
        ...
        <div className="bg-white border border-slate-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow flex flex-col justify-between h-32">
          ...
          <div>
            <p className="text-2xl font-bold text-slate-900">{stats.round1ScoresSubmitted}</p>
            <p className="text-sm text-slate-600 mt-1">Round 1 Scores Submitted</p>
          </div>
        </div>
        ...
        <div className="bg-white border border-slate-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow flex flex-col justify-between h-32">
          ...
          <div>
            <p className="text-2xl font-bold text-slate-900">{stats.round2ScoresSubmitted}</p>
            <p className="text-sm text-slate-600 mt-1">Round 2 Scores Submitted</p>
          </div>
        </div>
      </div>
      ...
      <Collapsible open={isJudgeFormOpen} onOpenChange={setIsJudgeFormOpen}>
        <div className="bg-white border border-slate-200 rounded-xl p-4 sm:p-6 shadow-sm hover:shadow-md transition-shadow">
          ...
          <CollapsibleContent className="pt-4">
            <form onSubmit={handleSaveJudge} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
              <div className="sm:col-span-1 lg:col-span-2">
                <label className="block text-xs sm:text-sm font-medium text-slate-700 mb-2">Judge Name</label>
                <input
                  value={judgeName}
                  onChange={(e) => setJudgeName(e.target.value)}
                  className="w-full px-3 sm:px-4 py-2 sm:py-3 bg-white border border-slate-300 rounded-lg text-sm sm:text-base text-slate-900 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200"
                  placeholder="Judge Name"
                  required
                />
              </div>
              <div className="sm:col-span-1">
                <label className="block text-xs sm:text-sm font-medium text-slate-700 mb-2">Judge ID</label>
                <input
                  value={judgeId}
              ...
              <div className="sm:col-span-1">
                <label className="block text-xs sm:text-sm font-medium text-slate-700 mb-2">Judge Type</label>
                <select
                  value={judgeType}
              ...
              <div className="sm:col-span-1 lg:col-span-2">
                <label className="block text-xs sm:text-sm font-medium text-slate-700 mb-2">Edit Existing (optional)</label>
                <select
              ...
              <div className="sm:col-span-1 lg:col-span-2 flex flex-col sm:flex-row items-start sm:items-end gap-2 sm:gap-3">
                <button
                  type="submit"
                  disabled={savingJudge}
                  className="w-full sm:w-auto px-4 sm:px-5 py-2 sm:py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium text-sm sm:text-base disabled:opacity-60"
                >
                ...
                {editingJudgeId && (
                  <button
                    ...
                    className="w-full sm:w-auto px-4 py-2 sm:py-3 border border-slate-300 text-slate-700 rounded-lg hover:bg-slate-50 text-sm sm:text-base"
                  >
                    Cancel
                  </button>
                )}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          >
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs text-slate-600 line-clamp-1">Scored: {round2ScoredTeams}/{round2AllocatedCount ?? '...'}</p>
            </div>
          </button>
        </div>
      </div>
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-4 sm:p-6 shadow-sm hover:shadow-md transition-shadow">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          ...
          >
            ...
            <div className="min-w-0">
              <p className="font-medium text-sm sm:text-base text-slate-900">View Allocations</p>
          ...
          >
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs text-slate-600">View real-time scores</p>
            </div>
          </Link>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          >
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs text-slate-600">All domains</p>
            </div>
          </button>
          ...
          >
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs text-slate-600">All teams</p>
            </div>
          </button>
        </div>
      </div>
